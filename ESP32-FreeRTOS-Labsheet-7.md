...
![ภาพ](https://github.com/user-attachments/assets/eb09ca16-4644-48bd-a4fa-62ba6b3dffb9)

การวิเคราะห์ผลที่ได้

Task1 จะทำหน้าที่ส่งข้อความ 3 ข้อความไปยัง queue แล้วทำงานในลูปไม่รู้จบ

Task2 จะรับข้อความจาก queue และพิมพ์ข้อความที่ได้รับออกมา

เนื่องจาก Task1 ส่งข้อความไปยัง queue และ Task2 รับข้อความจาก queue ทีละข้อความ ผลลัพธ์ที่แสดงจะเป็นข้อความที่ถูกส่งจาก Task1 โดย Task2 จะรับและแสดงผลข้อมูลตามลำดับที่ส่งไป
และโค้ดนี้จะไม่ทำให้ LED บน ESP32 ติดและดับ  

https://github.com/AnchisaPhetnoi/ESP-IDF-Queue.git
